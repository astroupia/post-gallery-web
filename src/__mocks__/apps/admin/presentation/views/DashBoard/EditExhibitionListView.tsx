...
export default class EditExhibitionListView extends ViewModelView<DashboardViewModel, any, DashboardState>{
    ...
    return (
        <div >
          ...
          <div className='flex flex-row flex-wrap'>
			{
				exhibitions.map(
					(exhibition: Exhibition) => <Link to={`/admin/exhibition/edit/${exhibition.getPK()}`} className='font-Lato w-full lg:w-2/5 flex flex-row justify-start items-center h-32 pr-3 mr-5 mb-6 font-medium border-[3px] rounded-md border-[#D6D6D6]'>
